...
/*9. A brand wants to know which hashtags to use in a post
...
/*
Error Code: 1055. Expression #2 of SELECT list is not in GROUP BY clause and contains nonaggregated column 'ig_clone.comments.comment_text' which is not functionally dependent on columns in GROUP BY clause; this is incompatible with sql_mode=only_full_group_by	0.109 sec
For this error, execute below query:-
*/
SET sql_mode=(SELECT REPLACE(@@sql_mode,'ONLY_FULL_GROUP_BY',''));

/*11. We also have a problem with celebrities
...
/*Mega Challenges
12. Are we overrun with bots and celebrity accounts?
